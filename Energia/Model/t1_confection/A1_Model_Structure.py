...
classifier_supply_sec_energy = pd.read_excel('./A1_Inputs/A-I_Classifier_Modes_Supply.xlsx', sheet_name='SecondaryEnergy') # ORANGE // Specifies Layout
...
codes_primary_secondary_demands_df_headers = [\
    ...
    'Secondary.Fuel.O', 'Demands.Fuel.I', 'Demands.Tech',
    'Demands.Fuel.O']
