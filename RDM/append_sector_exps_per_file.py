...
element_dict_2_co2 = {
 ...
 'co2_arroz': 'CO2e',
 'CO2_fugitivas': 'CO2e',
 'co2_suelo_indirectas': 'CO2e',
 'co2_urea': 'CO2e',
 'co2_gallinas': 'CO2e',
 'CO2e': 'CO2e',
 'co2_gestiondirectaestiercol': 'CO2e',
 'co2_ferm': 'CO2e',
 'CO2': 'CO2e',
 'co2_n20pastoreo': 'CO2e',
 'co2_encalado': 'CO2e',
 'co2_cultivos': 'CO2e',
 'CO2e_CEM': 'CO2e',
 'co2_cambio_de_uso': 'CO2e',
 'co2_remocion': 'CO2e'
}
...
included_scen_underscore = ['BAU_', 'DDP_']
included_scen = ['BAU', 'DDP']
    ...
    if exp not in exception_experiments:
        ...
        for scen in elements_in_exec_scen:
            ...
            if 'AFOLU' in exp:
                ...
                csv_df_raw['VarOpex2023'] = csv_df_raw['DiscountedOperatingCost']
                csv_df_raw['Opex2023'] = csv_df_raw['DiscountedOperatingCost']
