                ...
                if str( scenario_list[s] ) in Scenarios_Involved:
                    ...
                    for p in range( len( Parameters_Involved ) ):
                        ...
                        if 'Adjustment clinker factor' in X_Cat:
                            ...
                            tech_set, fuel_sets = split_string(str_sets)
                            ...
                            for a_fuel_set in fuel_sets:
                                ...
                                if a_fuel_set == 'CLK_PROD':
                                    ...
                                    new_value_list = [0.65 if i < 0.65 else 1 if i > 1 else i for i in new_value_list_raw]
                            ...
                            # print('review clinker adjustment')
                            # sys.exit()

                        #
                        elif 'Passenger Demand' in X_Cat:
                            #
                            if scenario_list[s] == 'BAU':
                            ...
                            #
                                ...
                                for a_set in range( len( Sets_Involved ) ):
                                    ...
                                    if this_parameter == 'EmissionActivityRatio':
                                        ...
                                        # print('Check emission factor variations')
                                        # sys.exit()
                                    #
